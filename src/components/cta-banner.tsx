...
export function CtaBanner() {
  return (
    <section id="waitlist" className="relative overflow-hidden border-t border-line py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-3xl px-5 text-center">
        <h2 className="font-display text-3xl font-bold leading-tight tracking-tight sm:text-5xl">
          Ready to ship <span className="text-accent">every month?</span>
        </h2>
        <p className="mx-auto mt-5 max-w-md text-base leading-relaxed text-muted">
          Join the waitlist and lock in launch pricing for the first cohort of
          mobcode teams.
        </p>
        <a
          href={`mailto:${"hello@mobcode.dev"}`}
